...
class Artist {
	...
	public static void addArtistToTxtFile(Map<String, String> artist) {
	...
	private static void updateArtistInTxtFile(String artistID, Map<String, String> updatedArtistInfo) {
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (currentArtistID.equals(artistID)) {
                    ...
                    updatedLine.append(updatedArtistInfo.get("ID")).append(";")
                            .append(updatedArtistInfo.get("Name")).append(";")
                            .append(updatedArtistInfo.get("Address")).append(";")
                            .append(updatedArtistInfo.get("Birthdate")).append(";")
                            .append(updatedArtistInfo.get("Bio")).append(";")
                            .append(updatedArtistInfo.get("Occupations")).append(";")
	...
	private static Artist validateArtistID(String artistID) {
        try (BufferedReader reader = new BufferedReader(new FileReader("Artists-list.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (currentArtistID.equals(artistID)) {
                    // Assuming the order of parts is ID, Name, Address, Birthdate, Bio, Occupations, Genres, Awards
	...
	public static boolean updateArtist() {
	    ...
	    do {
	        try {
	            System.out.println("Provide new information('fullname', 'birthdate', 'address', 'bio', 'occupation1,occupation2,...', 'award1,award2,...')");
